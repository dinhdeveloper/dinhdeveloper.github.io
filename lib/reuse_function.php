...
function pushNotification($title, $message, $action, $to, $type_send = 'topic', $server_key = 'AAAAAMwIRVM:APA91bE6CeLUe93OTDJJHHTAxS4yqYiLppuadN9n5k3J6N7JUfa9d_svNk0JoB1eyANLu0JyGQZ7J7nd_dikDzh7JbZCIKlycvRQGnsDX6vB6y0e7_zq3b1qIgMO1cXVca00uS9V-KaJ')
{
    $message_data = array(
        'title' => $title,
        'body' => $message,
